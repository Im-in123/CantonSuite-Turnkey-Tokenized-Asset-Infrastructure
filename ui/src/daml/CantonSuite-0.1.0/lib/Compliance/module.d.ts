...
export declare type ArchiveReview = {
};

export declare const ArchiveReview:
  damlTypes.Serializable<ArchiveReview> & {
  }
;
...
export declare interface ComplianceReviewInterface {
  ...
  ArchiveReview: damlTypes.Choice<ComplianceReview, ArchiveReview, {}, undefined> & damlTypes.ChoiceFrom<damlTypes.Template<ComplianceReview, undefined>>;
}
