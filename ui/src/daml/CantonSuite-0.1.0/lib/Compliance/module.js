...
,
  ...
  ArchiveReview: {
    template: function () { return exports.ComplianceReview; },
    choiceName: 'ArchiveReview',
    argumentDecoder: damlTypes.lazyMemo(function () { return exports.ArchiveReview.decoder; }),
    argumentEncode: function (__typed__) { return exports.ArchiveReview.encode(__typed__); },
    resultDecoder: damlTypes.lazyMemo(function () { return damlTypes.Unit.decoder; }),
    resultEncode: function (__typed__) { return damlTypes.Unit.encode(__typed__); },
  },
}
...
damlTypes.registerTemplate(exports.ComplianceReview, ['7b9176e372f3c95da11f9bf2f97adcba36185c02c3dea45b575c34d340321f53', '#CantonSuite']);
