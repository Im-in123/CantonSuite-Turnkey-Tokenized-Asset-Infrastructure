...
export declare const UpdateProfile:
  damlTypes.Serializable<UpdateProfile> & {
  }
;
...
export declare interface UserInterface {
  ...
  UpdateProfile: damlTypes.Choice<User, UpdateProfile, damlTypes.ContractId<User>, undefined> & damlTypes.ChoiceFrom<damlTypes.Template<User, undefined>>;
}
