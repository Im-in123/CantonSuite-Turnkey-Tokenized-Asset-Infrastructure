...
exports.RollConventionEnum = {
  decoder: damlTypes.lazyMemo(function () { return jtv.oneOf(jtv.object({tag: jtv.constant('EOM'), value: damlTypes.Unit.decoder, }), jtv.object({tag: jtv.constant('DOM'), value: damlTypes.Int.decoder, }), jtv.object({tag: jtv.constant('NoRollConvention'), value: damlTypes.Unit.decoder, })); }),
  ...
  switch(__typed__.tag) {
    ...
    case 'NoRollConvention': return {tag: __typed__.tag, value: damlTypes.Unit.encode(__typed__.value)};
